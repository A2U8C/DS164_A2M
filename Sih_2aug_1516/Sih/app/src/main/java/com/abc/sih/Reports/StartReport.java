...
public class StartReport extends Fragment {
    ...
    String disp_case_lat,disp_case_long;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_start_report, container, false);
    ...
    private void startSection() {
        Query ftp = mPostsDatabase.orderByChild("time");//.limitToLast(10);
                ...
                mPostsDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.child("name").getValue() != null && dataSnapshot.child("image").getValue() != null &&
                                ...
                                dataSnapshot.child("geo_lat").getValue()!=null && dataSnapshot.child("geo_long").getValue()!=null) {
                            ...
                            disp_case_lat = dataSnapshot.child("geo_lat").getValue().toString();
                            disp_case_long = dataSnapshot.child("geo_long").getValue().toString();
                            ...
                            }else
                            {
                                ...
                                photoViewHolder.setGeo_lat(disp_case_lat);
                                photoViewHolder.setGeo_long(disp_case_long);
                            }
...
*/
    ...
    public static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(@NonNull View itemView) {
            ...
            geo_lat = (TextView) mView.findViewById(R.id.geo_lat);
            geo_long = (TextView) mView.findViewById(R.id.geo_long);
        }
        public void setGeo_lat(String lat){
            geo_lat.setText(lat);
        }

        public void setGeo_long(String longg){
            geo_long.setText(longg);

        }

        public  void checkAccess(String id){

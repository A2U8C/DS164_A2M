...
public class AssignedFrag extends Fragment {
    ...
    private void UpdateUI() {
        ...
        final Query allot = FirebaseDatabase.getInstance().getReference().child("resource").child(Div).child(Rang).child(Beat).orderByChild("Assigned").equalTo(email);
        FirebaseRecyclerAdapter<resource, resourceHolder> fr = new FirebaseRecyclerAdapter<resource, resourceHolder>(
            ...
            protected void populateViewHolder(final resourceHolder resourceHolder, resource resource, int i) {
                ...
                FirebaseDatabase.getInstance().getReference().child("resource").child(Div).child(Rang).child(Beat).child(list_user_id).addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    public  static class resourceHolder extends RecyclerView.ViewHolder{
        ...
        public void setDeAllocate(String type, String assgn, String list_user_id, String Div, String Rang, String Beat) {
            ...
            DatabaseReference pol = FirebaseDatabase.getInstance().getReference().child("resource").child(Div).child(Rang).child(Beat).child(list_user_id);

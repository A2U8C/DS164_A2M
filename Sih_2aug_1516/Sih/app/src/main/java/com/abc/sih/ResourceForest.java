...
public class ResourceForest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_resource_forest, container, false);
    ...
    private void UpdateUI() {
        ...
        allot = FirebaseDatabase.getInstance().getReference().child("ForRes").child(Div).child(Rang).child(Beat);
    ...
    public  static class resourceHolder extends RecyclerView.ViewHolder{
        ...
        public void setDeAllocate(String type, String assgn, String list_user_id, String Div,String ran, String beat) {
            ...
            DatabaseReference pol = FirebaseDatabase.getInstance().getReference().child("ForRes").child(Div).child(ran).child(beat).child(list_user_id);

...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        DatabaseReference blue = FirebaseDatabase.getInstance().getReference().child("Zones").child("blue");
        ...
        blue.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    double lat = ds.child("lat").getValue(double.class);
                    ...
                    LatLng location = new LatLng(lat,lon);
                    Log.d("mapact_16","longit"+lon+"lattitude"+lat);
                    drawCircle(location,rad,"blue",title);
                }
            }

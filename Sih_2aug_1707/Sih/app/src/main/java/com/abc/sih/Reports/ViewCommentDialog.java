...
//                    userMap.put("Reason",rsn);
                    ...
                    FirebaseDatabase.getInstance().getReference().child("CommentReport").child(refId).child(rptId).child(mAuth.getUid()).setValue(rsn).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
